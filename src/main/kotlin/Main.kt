...
//    val name = arrayOf("Ashley","Dorcas","Michel","John","Jummy")
//    if("Ashley" in name) {
//        println("It has Ashley")
//    }else{
...
//    val stringInput1 = readLine()!!
//    print("Enter your cohort name -> ")
//    val stringInput2 = readLine()!!
//    println("My name is  $stringInput")
//    println("I am $stringInput1 years old")
